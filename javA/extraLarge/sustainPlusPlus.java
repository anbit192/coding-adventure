/**
 * Sustain++ code in java
 * This is my attempt of rebuilding this song - anbish
 */
...
import extraLarge.spaces.Simulation;
...
public class sustainPlusPlus {
    public static void main(String[] args) {
        ...
        world.addPollution("environment", "indecency", you);
        ...
        String[] vocab = {"sir", "yes", "no", "please", "thank you", "master", "red", "green", "yellow"};
        ...
        Vulnerability zeroDays = world.getVulnerability().getZerodays();
